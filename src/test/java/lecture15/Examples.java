...
public class Examples {
    ...
    public void testCheckBox() {
        ...
        WebElement homeLabel = driver.findElement(By.cssSelector("[for='tree-node-home']"));
        homeLabel.click();
    ...
    public void testCheckBoxExpand() {
        driver.get("https://demoqa.com/checkbox");
        // Find unique element move to parent and than to element we need to click
        // //*[@for="tree-node-home"]/../button
    ...
    public void testRadioButtons() {
        ...
        if(impressiveRadioButton.isEnabled()){
            Assert.assertTrue(impressiveRadioButton.isSelected());
        }else {
            System.out.println("The Immpresive radio button is disabled !");
        }
    ...
    public void testTables() {
        ...
        //Find email element index and store it
        int emailIndex = 0;
        ...
        //Find row by email value alden@example.com and delete it
        ...
        //Get refreshed table body and rows
