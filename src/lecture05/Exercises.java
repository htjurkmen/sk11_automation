...
public class Exercises {
    ...
    public static void printDynamicMatrixElements() {
        ...
        System.out.println(matrix); // will be highlited and on mouse over a way to properly print is suggested
        System.out.println("The matrix is created: " + Arrays.deepToString(matrix)); // Arrays.deepToString used to convert
        // multidimensional array elements to string so we can print it properly

        System.out.println("Our Matrix is: ");
        for(int[] printArr : matrix){
    ...
    public static void isPalindromBasic() {
