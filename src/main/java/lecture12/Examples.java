...
public class Examples {
    ...
    private static void testMyFirstWebDriver() {
        ...
        driver.get("http://training.skillo-bg.com:4300/posts/all"); //.get loads URL
    ...
    private static void testFindElement() {
        ...
        WebElement login = driver.findElement(By.id("nav-link-login")); //WebElement declaration
        driver.close();
    }
    ...
    private static void testFindElements() {
        ...
        //Finds all posts elements on Skillo page and adds them to a list of type WebElement
    ...
    private static void testClick() {
        ChromeDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10)); //sets implicit wait of 10 seconds for elements
    ...
    private static void testSendKeys() {
        ...
        //types string in username field
    ...
    private static void testClear() {
        ...
        username.sendKeys("test");
        //clears the content on text input field
        username.clear();
    ...
    private static void testCommonCommands() {
        ...
        //return text of the node as a string
